        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="<?=$baseurl?>" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">IDY</span>
                    <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">WEDDING</span>
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="<?=$baseurl?>/detail" class="nav-item nav-link">Shop Detail</a>
