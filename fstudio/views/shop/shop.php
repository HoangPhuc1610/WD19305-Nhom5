...
<div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <label class="custom-control-label" for="price-1">100.000VNĐ - 5.000VNĐ</label>
                ...
                <!-- Size Start -->
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Kích thước giày</span></h5>
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" checked id="size-all">
                            <label class="custom-control-label" for="size-all">Tất cả khích thước</label>
                            <span class="badge border font-weight-normal">1000</span>
                        </div>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="ml-2">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item" href="#">Sản phẩm phổ biến</a>
                                        <a class="dropdown-item" href="#">Sản phẩm được yêu thích</a>
                                    </div>
                                </div>
                                <div class="btn-group ml-2">
                                    <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Số lượng sản phẩm</button>
                                    <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <?php  foreach($getallproducts as $product)  {?>
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" style="height: 300px;" src="public/images/<?=$product['image']?>" alt="">
                            ...
                            <div class="text-center py-4">
                                ...
                                <h3 class="font-weight-semi-bold mb-4"><?=$product['sale']?>.VND<del style="font-size: 18px; color: gray; font-weight: 500; margin-left: 10px;"><?= $product['price']?></del></h3>
                                </div>
