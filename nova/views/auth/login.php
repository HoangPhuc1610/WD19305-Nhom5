...
<body>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="<?=$baseurl?>/register" class="signup-image-link">Create an account</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="postlogin" class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="your_name" placeholder="Email" value="<?= $_POST['email'] ?? ""?>"/>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="password" id="your_pass" placeholder="Password" value="<?= $_POST['password'] ?? ""?>"/>
                            </div>
                            <!-- <div class="form-group">
    ...
    <!-- JS -->
    <script src="public/auth/vendor/jquery/jquery.min.js"></script>
