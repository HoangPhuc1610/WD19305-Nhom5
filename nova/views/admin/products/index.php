...
<table class="table table-hover" border="1">
    ...
    <?= $product['status'] == 1 ? 'Hiện' : 'Ẩn' ?>
        ...
        <td>
            <a href="<?= $baseurl ?>/editproduct/<?= $product['id'] ?>" class="btn btn-primary">Edit</a> | 
            <a href="<?= $baseurl ?>/deleteproduct/<?= $product['id'] ?>" onclick="return confirm('Bạn có chắc muốn xóa?')" class="btn btn-danger">Delete</a>
        </td>
    </tr>
<?php } ?>
