        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4"><?=$product['price']?> VND<del style="font-size: 18px; color: gray; font-weight: 500; margin-left: 10px;"><?= $product['sale']?></del></h3>
                    <p class="mb-4"></p>
                    <div class="d-flex mb-3">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a class="btn btn-primary px-3" href="<?=$baseurl?>/addtocart/<?= $product['id'] ?>"><i class="fa fa-shopping-cart"></i>Add To Cart</a>
