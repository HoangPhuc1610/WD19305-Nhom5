        ...
        <div class="row px-xl-5">
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="public/img/bannergiay1.jpg" style="object-fit: cover;">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="public/img/bannergiay2.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="public/img/bannergiay3.webp" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="public/img/bannergiay4.jpg" alt="">
                ...
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="public/img/bannergiay5.webp" alt="">
                    <div class="offer-text">
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href=".bg-secondary pr-3">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="public/images/<?= $category['image']?>" alt="">
                        </div>
                    ...
                    <div class="product-item bg-light mb-4">
                        ...
                        <div class="text-center py-4">
                            ...
                            if (isset($newProduct['sale'])) {
                                echo '<small><h6 style="color: red;">' .$newProduct['price']. ' VNĐ</h6></small>';
                                echo '<small><h6 class="text-muted ml-2"><del>' . $newProduct['sale'] . ' VNĐ</del></h6></small>';
                            } else {
                                echo '<small><h6 style="color: red;">' .$newProduct['price']. ' VNĐ</h6></small>';
                            }
                            ?>
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <?php
                            if (isset($yonexProduct['sale'])) {
                                echo '<small><h6 style="color: red;">' .$yonexProduct['price']. ' VNĐ</h6></small>';
                                echo '<small><h6 class="text-muted ml-2"><del>' . $yonexProduct['sale'] . ' VNĐ</del></h6></small>';
                            } else {
                                echo '<small><h6 style="color: red;">' .$yonexProduct['price']. ' VNĐ</h6></small>';
                            }
                            ?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <?php
                            if (isset($mizu['sale'])) {
                                echo '<small><h6 style="color: red;">' .$mizu['price']. ' VNĐ</h6></small>';
                                echo '<small><h6 class="text-muted ml-2"><del>' . $mizu['sale'] . ' VNĐ</del></h6></small>';
                            } else {
                                echo '<small><h6 style="color: red;">' .$mizu['price']. ' VNĐ</h6></small>';
                            }
                            ?>
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <?php
                            if (isset($liningProduct['sale'])) {
                                echo '<small><h6 style="color: red;">' .$liningProduct['price']. ' VNĐ</h6></small>';
                                echo '<small><h6 class="text-muted ml-2"><del>' . $liningProduct['sale'] . ' VNĐ</del></h6></small>';
                            } else {
                                echo '<small><h6 style="color: red;">' .$liningProduct['price']. ' VNĐ</h6></small>';
                            }
                            ?>
                    ...
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        <?php
                            if (isset($victorProduct['sale'])) {
                                echo '<small><h6 style="color: red;">' .$victorProduct['price']. ' VNĐ</h6></small>';
                                echo '<small><h6 class="text-muted ml-2"><del>' . $victorProduct['sale'] . ' VNĐ</del></h6></small>';
                            } else {
                                echo '<small><h6 style="color: red;">' .$victorProduct['price']. ' VNĐ</h6></small>';
                            }
                            ?>
